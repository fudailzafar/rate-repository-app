...
/* 
TODO: Add Download functionality as well. Save to an album named HexCode into the user's gallery.
*/
const SharePalette = () => {
	...
	return (
		<View style={styles.container}>
			<Text style={styles.headerText}>My Color Palette | HexCode</Text>
			<ViewShot ref={ref}>
			...
			<Pressable
				...
				onPress={() => {
					const options = {
						url: uri,
						message: "Generated this palette using the #HexCode app!\nhttps://github.com/fudailzafar/HexCode",
					};
					Share.open(options);
				}}
			>
